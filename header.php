...
<html class="no-js" lang="zxx">
    <head>
		...
		<!-- Favicon -->
        <link rel="icon" href="<?php echo get_theme_file_uri("./assets/css/img/favicon.png") ?>">
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-7 col-12">
							...
							<ul class="top-contact">
								<li><i class="fa fa-phone"></i>01067359975</li>
								<li><i class="fa fa-envelope"></i><a href="mailto:support@yourmail.com">ahmed4230482@gmail.com
								</a></li>
							</ul>
							<!-- End Top Contact -->
						</div>
